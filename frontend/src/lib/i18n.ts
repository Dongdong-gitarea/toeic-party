...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'game.qType.cloze': '克漏字',
    'game.qType.clozeHint': '選出最適合空格的字',
    'game.qType.synonym': '同義/反義',
    'game.qType.synonymHint': '選出意思相近或相反的字',
    'game.qType.listen': '聽句子',
    'game.qType.listenHint': '聽句子，選出大意',
    'game.qType.audiocloze': '聽力克漏字',
    'game.qType.audioclozeHint': '邊讀邊聽，選出空格中的字',
    'game.tapToHear': '點擊發音',
    'game.whatWord': '聽到什麼字？',
  ...
  en: {
    ...
    'game.qType.cloze': 'CLOZE',
    'game.qType.clozeHint': 'Fill in the blank',
    'game.qType.synonym': 'SYN/ANT',
    'game.qType.synonymHint': 'Pick the syn / antonym',
    'game.qType.listen': 'LISTEN',
    'game.qType.listenHint': 'Listen to the sentence and pick the meaning',
    'game.qType.audiocloze': 'AUDIO CLOZE',
    'game.qType.audioclozeHint': 'Read and listen, then pick the missing word',
