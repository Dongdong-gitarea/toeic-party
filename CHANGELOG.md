...
### What was added (~629 new business-context sentences)

**T-U-V-W-X-Y-Z**: Comprehensive coverage of remaining alphabet including theology, theoretical, therapy, thermal, thesis, thick, thin, think, thinking, thorough, thoroughly, though, thought, thoughtful, thousand, thread, threat, threaten, threshold, thrill, thrive, through, throughout, thus, tick, ticket, tide, tidy, tie, tight, tighten, tightly, tile, till, timber, time, timeless, timely, timer, timetable, timing, tiny, tip, tired, title, to, together, tolerance, tolerate, tomato, tomorrow, ton, tone, tongue, tonight, tool, top, topic, total, totally, touch, tough, tour, tourism, tourist, tournament, tow, toward, towel, tower, town, toxic, toy, trace, track, tracking, trade, trader, tradition, traditional, traditionally, traffic, tragedy, tragic, trail, trailer, train, trained, trainee, trainer, training, trait, tram, tranquil, transaction, transcend, transcript, transfer, transform, transformation, transient, transit, transition, translate, translation, translator, transmission, transmit, transparency, transparent, transplant, transport, transportation, trap, trash, trauma, travel, traveler, tray, treasure, treasurer, treasury, treat, treatment, treaty, tree, tremendous, trend, trendy, trial, tribunal, tribute, trick, tricky, tried, trigger, trim, trip, triple, triumph, trivial, trophy, tropical, trouble, troubled, truck, true, truly, trumpet, trunk, trust, trusted, trustee, trustworthy, truth, truthful, try, tube, tuck, Tuesday, tug, tuition, tumble, tuna, tune, tunnel, turbulent, turkey, turmoil, turn, turning, turnout, turnover, tutor, TV, twelve, twenty, twice, twin, twist, two, type, typhoon, typical, typically, ugly, ultimate, ultimately, umbrella, unable, unanimous, unanimously, unaware, uncertain, uncertainty, unclear, uncomfortable, unconscious, uncover, under, undergo, undergraduate, underground, underline, underlying, undermine, underneath, understand, understanding, understood, undertake, underway, undesirable, undoubtedly, unemployed, unemployment, unexpected, unexpectedly, unfair, unfamiliar, unfit, unfold, unfortunate, unfortunately, unhappy, unhealthy, unidentified, uniform, uniformly, unify, union, unique, unit, unite, united, unity, universal, universe, university, unjust, unkind, unknown, unleash, unless, unlike, unlikely, unlimited, unload, unlock, unnecessary, unofficial, unpaid, unpleasant, unprecedented, unpredictable, unrelated, unreliable, unrest, unsafe, unsatisfactory, unstable, unsuccessful, until, untold, unusual, unusually, unveil, unwanted, unwilling, up, upcoming, update, upgrade, uphold, upon, upper, upright, upside, upstairs, upward, urban, urge, urgency, urgent, urgently, us, usable, usage, use, used, useful, useless, user, usual, usually, utensil, utility, utilize, utmost, vacant, vacation, vacuum, vague, valid, validity, valley, valuable, value, valued, vampire, van, vanish, vapor, variable, variation, varied, variety, various, vary, vast, vault, vegetable, vegetarian, vehicle, velocity, vendor, ventilation, venture, venue, verb, verbal, verdict, verge, verify, versatile, version, versus, vertical, very, vessel, veteran, veto, via, viability, viable, vice, vicinity, vicious, victim, Victorian, victorious, victory, video, view, viewer, viewpoint, vigor, villa, village, villager, vine, vinegar, vintage, vinyl, violate, violation, violence, violent, violently, violin, virgin, virtual, virtually, virtue, virtuous, virus, visa, visible, visibly, vision, visionary, visit, visitor, visual, visually, vital, vitamin, vivid, vocabulary, vocal, vocation, voice, void, volcano, volleyball, voltage, volume, voluntary, volunteer, vote, voter, voting, voucher, vow, voyage, vulgar, vulnerability, vulnerable, wage, wagon, waist, wait, waiter, waitress, waive, wake, walk, walker, wall, wallet, wander, wanted, war, ward, wardrobe, warehouse, warm, warmly, warmth, warn, warning, warranty, warrior, wash, washing, waste, wasteful, watch, water, waterfall, wave, wax, way, we, weak, weaken, weakness, wealth, wealthy, weapon, wear, weary, weather, web, webpage, website, wedding, Wednesday, week, weekday, weekend, weekly, weigh, weight, weird, welcome, welfare, well, well-being, wellness, went, were, west, western, wet, whale, what, whatever, wheat, wheel, wheelchair, when, whenever, where, whereas, wherever, whether, which, while, whip, whisper, white, who, whoever, whole, wholesale, wholly, whom, whose, why, wicked, wide, widely, widespread, width, wife, wild, wilderness, wildlife, wildly, will, willing, willingness, win, wind, window, wine, wing, winner, winning, winter, wipe, wire, wireless, wisdom, wise, wisely, wish, wit, with, withdraw, withdrawal, within, without, witness, witty, woke, wolf, woman, wonder, wonderful, wonderfully, wood, wooden, wool, word, work, workable, worker, workforce, working, workplace, workshop, world, world-class, worldly, worldwide, worn, worried, worry, worse, worst, worth, worthwhile, worthy, would, wound, wow, wrap, wrench, wrestle, wrist, wristwatch, write, writer, writing, wrong, X-ray, yacht, yard, yawn, year, yearly, yearn, yeast, yell, yellow, yen, yes, yesterday, yet, yield, yoga, yogurt, you, young, younger, your, yours, yourself, youth, youthful, zeal, zero, zest, zone, zoo

### Player impact
**3,004 non-TSL words** now eligible for cloze/audiocloze — approaching **26x** the original baseline. Total examples pool **6,223** — over **4.5x** the original 1,368.

### Verification
- TS clean
- Approaching 70% mark on non-TSL coverage. Entire alphabet now substantially covered.
...
### What was added (~600 new business-context sentences)

**P-Q**: promptly, pronounce, pronunciation, proof, proofread, propaganda, proper, properly, property, proportion, proposal, propose, proprietor, prospect, prospective, prosper, prosperity, protect, protection, protective, protein, protest, protocol, prototype, proud, proudly, prove, proven, provide, provider, province, provincial, provision, provoke, proximity, prudent, psychological, psychology, public, publication, publicity, publicize, publish, publisher, pull, pump, punch, punctual, punctuation, punish, punishment, purchase, purchaser, pure, purely, purify, purity, purpose, purposeful, pursue, pursuit, push, put, puzzle, qualification, qualified, qualify, qualitative, quality, quantitative, quantity, quarrel, quarter, quarterly, queen, quest, question, questionable, questionnaire, queue, quick, quickly, quiet, quietly, quit, quite, quotation, quote

**R**: race, racial, rack, racket, radar, radiation, radical, radically, radio, radius, rage, rail, railroad, railway, rain, rainfall, rainy, raise, rally, ramp, random, randomly, range, rank, ranking, ransom, rapid, rapidly, rare, rarely, rat, rate, rather, ratification, ratify, rating, ratio, rational, rationale, raw, reach, react, reaction, read, reader, readily, readiness, ready, real, realistic, reality, realization, realize, really, rear, reason, reasonable, reasonably, reasoning, reassuring, rebel, rebellion, rebuild, recall, receipt, receive, recent, recently, reception, recession, recipe, recipient, reciprocal, recognise, recognition, recognize, recommend, recommendation, reconcile, reconciliation, reconsider, record, recorder, recording, recover, recovery, recreation, recreational, recruit, recruiter, recruitment, rectangular, rectify, recur, recurrence, recurring, recycle, redeem, redemption, redo, reduce, reduction, redundant, refer, reference, referee, referendum, referral, refine, refined, refinement, refinery, reflect, reflection, reform, refrain, refresh, refreshing, refreshment, refrigerator, refugee, refund, refundable, refusal, refuse, regain, regard, regarding, regardless, regime, region, regional, register, registered, registration, regret, regrettable, regrettably, regular, regularity, regularly, regulate, regulation, regulator, regulatory, rehabilitation, rehearse, reign, reinforce, reinforcement, reinstate, reject, rejection, rejoice, relate, related, relation, relationship, relative, relatively, relax, relaxation, relaxed, relay, release, relevance, relevant, reliable, reliance, relief, relieve, religion, religious, reluctance, reluctant, rely, remain, remainder, remark, remarkable, remarkably, remedy, remember, remind, reminder, reminiscent, remit, remittance, remote, remotely, removal, remove, renaissance, render, renew, renewal, renowned, renown, rent, rental, repair, repay, repayment, repeat, repel, repent, repetition, repetitive, replace, replacement, replica, reply, report, reportedly, reporter, reporting, represent, representation, representative, repress, reprint, reproach, reproduce, reproduction, reptile, republic, republican, reputable, reputation, request, require, required, requirement, rescue, research, researcher, resemblance, resemble, resent, resentment, reservation, reserve, reserved, reservoir, reshape, reside, residence, resident, residential, resign, resignation, resilient, resist, resistance, resistant, resolution, resolve, resort, resource, resourceful, respect, respectable, respected, respective, respectively, respond, response, responsibility, responsible, responsive, rest, restaurant, restless, restore, restraint, restrict, restriction, restrictive, result, resume, retail, retailer, retain, retention, retire, retired, retirement, retreat, retrieve, return, reunion, reveal, revelation, revenge, revenue, reverse, review, reviewer, revise, revision, revival, revive, revolt, revolution, revolutionary, revolutionize, revolve, reward, rewarding, rhetoric, rhythm, rib, ribbon, rice, rich, rid, ride, rider, ridicule, ridiculous, rifle, rig, right, rigid, rigorous, ring, riot, rip, ripe, rise, rising, risk, risky, ritual, rival, rivalry, river, road, roar, rob, robber, robbery, robot, robotics, robust, rock, rocket, rod, role, roll, roller, romance, romantic, roof, room, root, rope, rose, rotation, rotten, rough, roughly, round, route, routine, row, royal, royalty, rub, rude, rug, ruin, rule, ruler, rumour, run, runner, running, rural, rush

**S** (first batch): sack, sacred, sacrifice, sad, sadly, sadness, safari, safe, safely, safety, said, sail, sailor, saint, sake, salad, salary, sale, salesman, salesperson, salon, salt, salute, salvage, same, sample, sanction, sand, sandal, sandwich, sandy, sane, sanity, sat, satellite, satisfaction, satisfactorily, satisfactory, satisfy, sauce, sauna, sausage, save, saving, saw, say, saying, scale, scan, scandal, scant, scar, scarce, scarcely, scarcity, scare, scared, scarf, scary, scatter, scattered, scenario, scene, scenic, scent, sceptical, schedule, scheme, scholar, scholarship, school, science, scientific, scientist, scissors, scold, scope, score, scorn, scout, scramble, scrap, scrape, scratch, scream, screen, screening, screw, script, scripture, sculpture, sea, seafood, seal, sealed, search, season, seasonal, seat, second, secondary, secondhand, secret, secretary, sect, section, sector, secure, security, sedan, see, seed, seek, seem, segment, segregate, seize, seldom, select, selection, selective, self, selfish, self-employed, sell, seller, semester, seminar, senate, send, sender, senior, seniority, sensation, sense, sensible, sensitive, sensor, sent, sentence, sentiment, separate, separately, separation, sequence, sergeant, serial, series, serious, seriously, sermon, servant, serve, server, service, session, set, setback, setting, settle, settlement, seven, seventy, several, severance, severe, severely, severity, sew, sewing, sex, sexist, sexual, shabby, shade, shadow, shake, shaky, shall, shallow, shame, shameful, shameless

### Player impact
**2,361 non-TSL words** now eligible for cloze/audiocloze — **20x** the original baseline. Total examples pool **4,981**, approaching 5,000 examples.

### Verification
- TS clean
- Past halfway mark on non-TSL coverage

## 2026-05-08 (Mobile) — Round 11: +740 non-TSL examples (37.8% → 47.5%)

M-N-O-P heavy round. Approaching the halfway mark for non-TSL example coverage.
...
### What was added (~740 new business-context sentences)

**M-N-O-P-R**: meeting, melody, melt, member, membership, memo, memorable, memorize, memory, mental, mention, menu, merchandise, merchant, mere, merely, merge, merger, message, messenger, metal, method, methodology, metropolitan, mid, middle, midnight, might, mighty, mild, mile, mileage, milestone, milk, million, mind, minimal, minimize, minimum, minor, minority, minute, miracle, mirror, miscellaneous, miserable, mislead, misleading, miss, missing, mission, mistake, mistaken, mister, misunderstand, mix, mixed, mode, model, moderate, modern, modernize, modest, modification, modify, module, mom, moment, momentum, monetary, money, monitor, month, monthly, monument, mood, moral, morale, more, moreover, morning, mortal, most, mostly, mother, motion, motivate, motivation, motive, motor, mount, mountain, move, movement, movie, moving, much, multimedia, multiple, multiply, museum, music, musical, musician, must, mutual, myself, mysterious, mystery, naked, name, namely, narrative, narrow, nasty, nation, national, nationality, native, natural, naturally, nature, near, nearby, nearly, neat, necessarily, necessary, neck, need, needle, negative, neglect, negotiate, negotiation, neighbor, neighborhood, neighbour, neither, nephew, nerve, nervous, net, network, networking, neutral, never, nevertheless, new, newly, news, newspaper, newsstand, next, nice, niche, night, nine, no, noble, nobody, nod, noise, noisy, nominate, nomination, none, nonetheless, noon, nor, norm, normal, normally, north, northern, note, notebook, noted, nothing, notice, noticeable, notify, notion, notorious, novel, novelty, now, nuclear, numerous, nurse, oak, obey, object, objection, objective, objectively, objectivity, obligation, obligatory, oblige, observation, observe, observer, obstacle, obstruct, obtain, obvious, obviously, occasion, occasional, occasionally, occupation, occupational, occupy, occur, occurrence, ocean, odd, of, off, offence, offend, offensive, offer, office, officer, official, officially, offshore, often, oh, oil, okay, old, olive, omit, on, once, one, onion, online, only, onset, onto, open, opening, openly, opera, operate, operation, operational, operator, opinion, opponent, opportunity, oppose, opposed, opposite, opposition, opt, optical, optimal, optimism, optimistic, option, optional, oral, orange, orbit, orchard, orchestra, order, orderly, ordinary, organic, organism, organization, organize, organized, organizer, orientation, origin, original, originally, originate, other, otherwise, ought, our, ours, ourselves, out, outage, outbreak, outcome, outdated, outdo, outdoor, outer, outfit, outgoing, outlet, outline, outlook, output, outright, outset, outside, outsider, outsource, outstanding, oval, over, overall, overcame, overcoat, overcome, overcrowd, overflow, overhead, overlap, overlook, overnight, overseas, oversee, overtake, overtime, overwhelm, overwhelming, owe, own, owner, ownership, pace, pacific, pack, package, packed, page, pain, painful, painfully, paint, painter, painting, pair, pale, pan, panel, panic, paper, paperback, paperwork, parade, paradox, paragraph, parallel, parameter, parcel, parent, parental, park, parliament, part, partial, partially, participant, participate, participation, particular, particularly, partly, partner, partnership, party, pass, passage, passenger, passing, passion, passionate, passive, passport, password, past, paste, patch, patent, paternal, path, patience, patient, patrol, patron, patronage, pause, pave, payment, peace, peaceful, peak, peer, pen, penalize, penalty, pencil, penetrate, penny, pension, people, pepper, per, perceive, percent, percentage, perception, perfect, perfectly, perform, performance, performer, perhaps, period, periodical, periodically, perishable, permanent, permanently, permission, permit, persist, persistence, persistent, person, personal, personality, personally, personnel, persuade, persuasive, pet, petition, petrol, pharmaceutical, pharmacist, pharmacy, phase, philosophy, phone, photo, photograph, photographer, photography, phrase, physical, physically, physician, physics, piano, pick, picnic, picture, pie, piece, pile, pill, pillar, pillow, pilot, pin, pinch, pine, pink, pioneer, pipe, pipeline, pirate, pit, pitch, pizza, place, placement, plain, plane, plant, plastic, plate, platform, play, player, playful, please, pleased, pleasure, pledge, plenty, plot, plow, plug, plumber, plus, pocket, poem, poet, point, pointed, pointless, poison, pole, police, policy, polish, polite, politely, political, politician, politics, pollute, pollution, pond, pool, poor, popcorn, popular, popularity, population, port, portable, portfolio, portion, portray, position, positive, positively, possess, possession, possibility, possible, possibly, post, postage, postal, postcard, poster, postpone, pot, potato, potent, potential, potentially, pottery, poultry, pound, pour, poverty, powder, power, powerful, practical, practically, practice, practitioner, pragmatic, praise, pray, precaution, precede, precedence, precedent, preceding, precept, precious, precise, precisely, precision, predator, predecessor, predict, predictable, prediction, predominant, predominantly, preface, prefer, preferable, preference, pregnancy, pregnant, preliminary, premier, premiere, premise, premises, premium, preoccupied, prepaid, preparation, preparatory, prepare, preparedness, preposition, prerequisite, prescribe, prescription, presence, present, presentation, presently, preservation, preserve, preside, president, presidential, press, pressing, pressure, prestige, prestigious, presume, presumption, pretend, pretty, prevail, prevailing, prevent, prevention, preventive, preview, previous, previously, prey, price, pride, primary, prime, primitive, princess, principal, principle, print, printer, printing, prior, priority, prison, prisoner, privacy, private, privately, privilege, privileged, prize, probability, probable, probably, probation, probe, problem, problematic, procedure, proceed, process, processor, proclaim, procure, produce, producer, product, production, productive, productivity, profession, professional, professionalism, professor, profile, profit, profitable, profound, program, programmer, progress, progression, progressive, prohibit, project, projection, projector, prolong, prominence, prominent, promise, promising, promote, promotion, prompt

### Player impact
**2,048 non-TSL words** now eligible for cloze/audiocloze — over **17x** the original baseline of 118. The total examples pool now exceeds 4,300, which is 3.2x the original 1,368.

### Verification
- TS clean
- Examples pool now larger than the original auto-generated corpus

## 2026-05-08 (Mobile) — Round 10: +610 non-TSL examples (29.6% → 37.8%)
...
### What was added (~610 new business-context sentences)

**H-I**: hardly, hardship, hardware, harm, harmful, harmony, harness, harsh, harvest, haste, hat, hate, haunt, have, haven, hazard, hazardous, he, head, headache, headline, headphone, headquarters, heal, healing, health, healthcare, healthy, heap, hear, hearing, heart, heaven, heavily, heavy, heightened, helicopter, hello, helmet, help, helpful, helpless, hence, her, herald, here, hereby, heritage, hero, hers, herself, hesitant, hesitate, hesitation, hide, hierarchy, high, highlight, highly, highway, hijack, hike, hill, him, himself, hint, hire, his, historic, historical, history, hit, hobby, hold, holder, holding, hole, holiday, home, homeowner, hometown, homework, honest, honestly, honesty, honor, honorary, hood, hook, hop, hope, hopefully, horizon, horizontal, horn, horror, horse, hospital, hospitality, host, hostage, hostile, hot, hotel, hour, ice, idea, ideal, ideally, identical, identification, identify, identity, ideology, idiom, idle, idol, if, ignite, ignorance, ignore, ill, illegal, illegitimate, illness, illuminate, illusion, illustrate, illustration, image, imaginary, imagination, imagine, imitate, imitation, immediate, immediately, immense, immigrant, immigration, imminent, immune, impact, impair, impatient, imperfect, imperial, impersonal, implement, implementation, implication, imply, import, importance, important, impose, impossible, impractical, impress, impression, imprisonment, improper, improve, improvement, improvise, in, inadequate, inappropriate, incentive, incident, incidental, incidentally, incline, include, including, inclusion, income, incoming, incorporate, incorporated, incorrect, increase, increasing, increasingly, incredible, incredibly, incur, indeed, indefinite, independence, independent, independently, index, indicate, indication, indicator, indifferent, indigenous, indirect, individual, individualism, individually, indoor, induce, induction, industrial, industrious, industry, inevitable, inevitably, infant, infect, infection, infectious, infer, inference, inferior, infinite, inflate, inflation, inflict, influence, influential, inform, informal, information, infrastructure, ingenious, ingredient, inhabit, inhabitant, inherent, inherit, inheritance, initial, initially, initiate, initiative, inject, injection, injure, injury, injustice, ink, inland, inner, innocent, innovation, inquire, insane, insect, insert, inside, insider, insight, insist, inspect, inspection, inspector, inspire, inspiring, install, instant, instantly, instead, instinct, institute, institution, instruct, instruction, instructor, instrument, insufficient, insulation, insult, insurance, insurer, integrate, integration, integrity, intellectual, intelligence, intelligent, intend, intense, intensive, intent, intention, intentional, intentionally, interact, interaction, interactive, intercept, interest, interesting, interface, interfere, interim, interior, intermediate, intern, internal, international, internet, interpret, interpretation, interpreter, interrupt, interruption, interval, intervene, intervention, interview, into, intolerable, intolerance, intricate, intriguing, introduce, introduction, introductory, invade, invasion, invent, invention, inventor, inventory, invest, investigate, investigation, investment, investor, invitation, invite, invoke, involve, involvement, inward

**J-M**: jacket, jail, jam, janitor, jar, jaw, jealous, jeans, jelly, jewel, jewellery, jewelry, job, jog, join, joint, jointly, joke, journal, journalism, journalist, journey, joy, judge, judgement, judicial, juice, jumble, jump, jumper, jungle, junior, junk, jurisdiction, jury, just, justice, justify, keen, keep, keeper, kennel, kettle, key, keyboard, kick, kid, kidnap, kidnapping, kidney, kill, killer, kilogram, kilometer, kind, kindly, kindness, king, kingdom, kiss, kit, kitchen, knee, kneel, knit, knock, knot, know, know-how, knowingly, knowledge, known, lab, label, labor, laboratory, labour, ladder, lady, lag, lake, lame, lamp, land, landlord, landmark, landscape, lane, language, lap, large, largely, laser, last, lasting, lastly, late, lately, later, latest, laugh, laughter, launch, laundry, law, lawn, lawsuit, lawyer, lay, layer, layout, lazy, lead, leader, leadership, leading, leaf, leaflet, league, lean, leap, learn, learner, learning, least, leather, leave, lecture, left, leg, legacy, legal, legally, legend, legendary, legible, legislation, legislative, legitimate, leisure, lemon, lend, length, lengthen, lengthy, lens, less, lessen, lesson, let, lethal, letter, level, liable, liaise, liaison, liar, liberal, liberate, liberty, librarian, library, license, lid, lie, lifelong, lifestyle, lifetime, lift, light, lightly, lightning, like, likelihood, likely, liken, likewise, limestone, limit, limitation, limited, limousine, limp, line, lineup, linger, linguistic, lining, link, lion, lip, liquid, list, listed, listen, listener, literacy, literal, literally, literary, literature, live, lively, liver, living, load, loaf, loan, lobby, local, locate, location, lock, lodge, lodging, log, logical, logically, logo, lone, lonely, long, long-term, longevity, longing, look, loop, loose, loosen, lose, loser, loss, lost, lot, lottery, loud, loudly, lounge, love, lovely, lover, low, lower, loyal, loyalty, luck, lucky, luggage, lump, lunch, lunchbox, lunchtime, lush, luxury, machine, machinery, mad, madam, magazine, magic, magical, magnet, magnetic, magnificent, magnitude, mail, mailbox, main, mainland, mainly, mainstream, maintain, maintenance, majestic, major, majority, make, maker, makeup, male, mall, man, manage, manageable, management, manager, mandate, mandatory, maneuver, manifest, manipulate, mankind, manner, manor, manpower, mansion, manual, manufacture, manufacturer, manuscript, many, map, march, margin, marginal, marine, mark, marked, marker, market, marketing, marketplace, marriage, married, marry, marvel, marvelous, mascot, mask, mass, massive, master, masterpiece, match, matching, material, maternity, mathematics, matter, mature, maximum, maybe, mayor, me, meal, mean, meaning, meaningful, meaningless, means, meanwhile, measurable, measure, measurement, meat, mechanic, mechanical, mechanism, medal, media, mediate, mediator, medical, medicine, meditate, meditation, medium, meet

### Player impact
**1,630 non-TSL words** now eligible for cloze/audiocloze — nearly 14x the original baseline of 118.

### Verification
- TS clean
- Examples pool: 3,643 (was 3,033)
