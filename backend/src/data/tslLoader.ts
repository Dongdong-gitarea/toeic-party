...
function generateConfusableQuestions(count: number, used: Set<string>): Question[] {
  ...
  const CONF_SENTENCES: Record<string, [string, number]> = {
    ...
    // Round 2 additions — 30 new pair templates
    'access|excess': ['Employees need a keycard to ___ the building.', 0],
    'excess|access': ['The ___ baggage fee is fifty dollars per kilo.', 1],
    'specific|specify': ['Please ___ the colour and size when ordering.', 1],
    'specify|specific': ['Please give ___ examples in the report.', 1],
    'effective|efficient': ['The new strategy was very ___ in boosting sales.', 0],
    'efficient|effective': ['Our team is very ___ at completing tasks quickly.', 0],
    'practice|practise': ['She goes to dance ___ every Tuesday evening.', 0],
    'license|licence': ['You need a driver\'s ___ to rent a car here.', 0],
    'canvas|canvass': ['The artist painted on a large ___ in the studio.', 0],
    'canvass|canvas': ['Volunteers will ___ the neighbourhood before the election.', 0],
    'suit|suite': ['She wore a navy ___ to the interview.', 0],
    'suite|suit': ['We booked the executive ___ on the top floor.', 0],
    'altar|alter': ['Please do not ___ the contract without permission.', 1],
    'alter|altar': ['We need to ___ the schedule to accommodate the new team.', 0],
    'birth|berth': ['Her ___ weight was seven pounds at the hospital.', 0],
    'berth|birth': ['Please make sure your ___ is reserved on the overnight train.', 0],
    'cite|sight': ['Always ___ your sources when writing a report.', 0],
    'sight|cite': ['The mountain came into ___ as the fog lifted.', 0],
    'flair|flare': ['She has a real ___ for graphic design.', 0],
    'flare|flair': ['The signal ___ lit up the night sky.', 0],
    'quiet|quit': ['The library has a ___ reading area on the third floor.', 0],
    'quit|quiet': ['He decided to ___ his job and start his own business.', 0],
    'waiver|waver': ['Please sign the liability ___ before the activity.', 0],
    'waver|waiver': ['Her commitment to the project did not ___ for a moment.', 0],
    'allusion|illusion': ['The speech made an ___ to the company\'s founding.', 0],
    'illusion|allusion': ['The painter created the ___ of depth on a flat canvas.', 0],
    'ascent|assent': ['The mountain ___ took three days to complete.', 0],
    'assent|ascent': ['The board gave its full ___ to the new policy.', 0],
    'continual|continuous': ['The ___ rain made the outdoor event impossible.', 1],
    'continuous|continual': ['She faced ___ interruptions during the call.', 1],
    'historic|historical': ['The signing of the contract was a ___ moment for our firm.', 0],
    'historical|historic': ['Many ___ documents are stored in the archive.', 0],
  };
